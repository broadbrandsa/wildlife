...
export const EQUIPMENT: Equipment[] = [
    {
        ...
        effect: "Standard issue for every dog on the roster. The paid kit below is what changes the hunt.",
    ...
    },
    {
        ...
        effect: "Stocks a binocular scan power-up. Use it to glass the bush and turn up a species right where you stand, any time you like.",
    ...
    },
    {
        ...
        effect: "Reveals a paid tracking intel clue on where the pack has worked, and once the trail is fresh the collar reads the range to the suspect.",
    ...
    },
    {
        ...
        effect: "Call HQ to hear where other teams have picked up the scent, so you know which end of the park to work.",
    ...
    },
    {
        ...
        effect: "Adds an exact bearing to every scent read.",
    ...
    },
    {
        ...
        tier: "hunt",
        priceZar: 40,
        description: "Rations to keep a K9 team fed on a long deployment in the bush.",
        effect: "Stocks a field rations power-up. Use it to top up your food supply out in the bush, with no trip to a rest camp.",
        fundedEquivalent: "A few days of field rations for a K9 team",
        icon: "fork-knife",
        realWorldNote: "Anti-poaching teams carry their own supplies deep into the reserve. Fresh rations keep a handler and dog out on the ground for longer.",
        consumable: true,
    },
    {
        id: "trail-rations",
        ...
        tier: "hunt",
        priceZar: 60,
        description: "Hard tack and energy to keep a ranger moving on a long follow-up.",
        effect: "Stocks a trail rations power-up. Use it while walking to push on and reach your destination now, ending the walk early.",
        fundedEquivalent: "A day's field rations for a ranger",
        icon: "cookie",
        realWorldNote: "On a long follow-up rangers eat on the move. A pocket of energy can be the difference between staying on a trail and losing it.",
        consumable: true,
    },
];
