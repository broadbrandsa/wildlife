...
export const EQUIPMENT: Equipment[] = [
    ...
    },
    {
        ...
        effect: "Doubles your map zoom for reading the ground closely, and widens the reach around your ranger where species markers appear, so more show up to spot.",
    ...
    },
    {
        ...
        effect: "Refuels your dog so it can track again right away, with no wait for it to rest. A dog tires after each track and needs time to recover.",
        fundedEquivalent: "About two days of food for one working dog",
        icon: "bone",
