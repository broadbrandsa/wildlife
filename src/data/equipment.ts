...
export const EQUIPMENT: Equipment[] = [
    ...
    },
    {
        ...
        tier: "hunt",
        priceZar: 40,
        description: "A high-energy feed for a working dog between casts.",
        effect: "Stocks a dog ration power-up. Use it to feed your dog and send it straight back on the scent, no wait for it to rest.",
        fundedEquivalent: "About two days of food for one working dog",
        icon: "bone",
        realWorldNote: "Tracking dogs burn hard on a follow-up. Handlers rest and feed them between casts to keep the nose sharp and the drive high.",
        consumable: true,
    },
    {
        id: "trail-rations",
